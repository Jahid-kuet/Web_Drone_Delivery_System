...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-3xl mx-auto">
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">
                    <i class="fas fa-clipboard-list text-orange-600 mr-2"></i>Create Delivery Request
                </h1>
                <p class="text-gray-600 mt-1">Submit a new delivery request</p>
            </div>
        ...
        {{-- INSERT: Create new delivery request in database --}}
        <div class="bg-white rounded-lg shadow-lg p-6">
            <form action="{{ route('admin.delivery-requests.store') }}" method="POST">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <select name="medical_supply_id" required
                            ...
                            @foreach($medicalSupplies as $supply)
                                <option value="{{ $supply->id }}" {{ old('medical_supply_id') == $supply->id ? 'selected' : '' }}>
                                    {{ $supply->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <input type="datetime-local" name="required_by" value="{{ old('required_by') }}" required
