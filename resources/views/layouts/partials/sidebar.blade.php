...
<div class="flex flex-col h-full">
    ...
    <div class="flex-1 overflow-y-auto">
        ...
        @if(auth()->user()->roles->whereIn('slug', ['super_admin', 'admin'])->count() > 0)
            <div class="space-y-1 mb-4">
                ...
                <a href="{{ route('admin.notifications.inbox') }}" class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.notifications.inbox') ? 'bg-teal-600 text-white' : 'text-gray-300 hover:bg-gray-800' }}">
                    <i class="fas fa-inbox w-5"></i>
                    <span class="ml-3">My Notifications</span>
                </a>

                <a href="{{ route('admin.notifications.create') }}" class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.notifications.create') || request()->routeIs('admin.notifications.index') ? 'bg-teal-600 text-white' : 'text-gray-300 hover:bg-gray-800' }}">
                    <i class="fas fa-paper-plane w-5"></i>
                    <span class="ml-3">Send Notifications</span>
                </a>
        ...
        @if(auth()->user()->roles->where('slug', 'drone_operator')->count() > 0)
            <div class="space-y-1 mb-4">
                ...
                <a href="{{ route('operator.notifications.inbox') }}" class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('operator.notifications.*') ? 'bg-purple-600 text-white' : 'text-gray-300 hover:bg-gray-800' }}">
                    <i class="fas fa-bell w-5"></i>
                    <span class="ml-3">Notifications</span>
                </a>
            </div>
    ...
    {{-- Logout Link (Always visible at bottom) --}}
    <div class="pt-4 border-t border-gray-700 bg-gray-900 px-4">
